...
--
-- Host: localhost    Database: ebanca
-- ------------------------------------------------------
...
CREATE TABLE `movimientos` (
  ...
  CONSTRAINT `fk2_ccuenta` FOREIGN KEY (`cod_cuenta`) REFERENCES `cuentas` (`cod_cuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `tiene` (
  ...
  KEY `dd` (`dni`),
  KEY `fk2_tccuenta` (`cod_cuenta`),
  CONSTRAINT `fk1_tdni` FOREIGN KEY (`dni`) REFERENCES `clientes` (`dni`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk2_tccuenta` FOREIGN KEY (`cod_cuenta`) REFERENCES `cuentas` (`cod_cuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-02-01 13:43:44
